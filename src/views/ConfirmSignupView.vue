    ...
    <div class="parent-container">
      <div class="auth-container">
        ...
        <form @submit.prevent="handleOTPConfirm">
          ...
          <el-button type="submit" style="background-color: #4caf50; margin-top: 15px;" color="#4caf50" @click="handleOTPConfirm" round>Confirm OTP</el-button>
        </form>
      </div>
    </div>
  </template>
  ...
  export default {
    ...
    methods: {
      ...
      async handleOTPConfirm() {
        try {
          await confirmSignUp(this.userId, this.otp);
